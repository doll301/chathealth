  ...
  const PreventionContent = () => (
    ...
    <ScrollView style={{ marginTop: 12 }}>
              <View style={styles.boxed_content}>
                <Text style={styles.boxed_content_text}>It is important to incorporate physical activity into your routine. UMD RecWell offers recreational services that can help you get started!</Text>
              </View>
              <View style={styles.boxed_content}>
                <Text style={styles.boxed_content_text}>A good diet can support both physical and mental health. The Nutrition Service offers resources to maintain a healthy diet.</Text>
              </View>
        </ScrollView>
      </View>
  );
  const ServicesContent = () => (
    ...
    <ScrollView style={{ marginTop: 12}}>
              <TouchableOpacity style={styles.boxed_content} onPress={() => WebBrowser.openBrowserAsync("https://umterps.com/sports/2018/3/12/sports-medicine-services.aspx")}>
                <Text style={styles.boxed_content_text} >Sports Medicine Services provides injury evaluation and treatment plans, weekly onsite clinics and game coverage for UMD intercollegiate athletes.</Text>
              </TouchableOpacity>
        ...
        <View>
          ...
          >
            <View style={styles.common_topics}>
              ...
              <Text style={styles.detail_text}>Sports Medicine Services provides injury evaluation and treatment plans, weekly onsite clinics and game coverage for UMD intercollegiate athletes.</Text>
            </View>
            <View style={styles.common_topics}>
              <Text style={styles.topic_text}>UMD RecWell</Text>
